...
REDIS_HOST_VALUE="${REDIS_HOST:-$(optional_memory_field '### Redis' 'Host')}"
REDIS_PORT_VALUE="${REDIS_PORT:-$(optional_memory_field '### Redis' 'Port')}"
REDIS_PASSWORD_VALUE="${REDIS_PASSWORD:-$(optional_memory_field '### Redis' 'Password')}"
...
(
  ...
  env \
    ...
    REDIS_HOST="${REDIS_HOST_VALUE:-localhost}" \
    REDIS_PORT="${REDIS_PORT_VALUE:-6379}" \
